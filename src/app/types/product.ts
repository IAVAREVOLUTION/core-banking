...
export type TipoPlantilla = 'solicitud' | 'contrato' | 'pagare' | 'minuta' | 'carta-oferta';
...
export const TIPO_PLANTILLA_OPTIONS: TipoPlantilla[] = ['solicitud', 'contrato', 'pagare', 'minuta', 'carta-oferta'];
